...
public class CacheServiceTests
{
    ...
    public async Task CacheAdd_ValidPackageSpecifier_AddsCache()
    {
        ...
        packageRegistryMock.Setup(r => r.GetManifest(It.IsAny<PackageSpecifier>())).ReturnsAsync(PackageManifest.Create(JsonDocument.Parse(packageManifestData).RootElement));
